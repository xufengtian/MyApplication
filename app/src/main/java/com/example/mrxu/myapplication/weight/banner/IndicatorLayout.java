package com.example.mrxu.myapplication.weight.banner;
...
import com.example.mrxu.myapplication.weight.banner.core.IndicatorAble;
...
public class IndicatorLayout extends LinearLayout implements IndicatorAble {
    ...
    private void dealAttrs(AttributeSet attrs) {
        ...
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.IndicatorLayout_indicator_widths, dip8);
        ...
        if (mSelectedDrawable == null) {
            mSelectedDrawable = createDrawable(Color.parseColor("#F18000"), mIndicatorWidth, mIndicatorHeight);
